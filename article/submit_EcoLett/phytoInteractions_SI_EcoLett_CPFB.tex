...
Linkage density and weighted connectance were described in \citet{bersier_quantitative_2002}. Linkage density can
...
\begin{figure}[H]
\begin{centering}
\includegraphics[width=1\textwidth]{../graphe/sparsity_vs_others_species2taxa}
\par\end{centering}
