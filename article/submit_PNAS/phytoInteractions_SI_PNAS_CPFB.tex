...
and widespread facilitative interactions between genera of phytoplankton
...
Study sites are shown on Fig. \ref{fig:Map} and the
characteristics of each site are given in Table \ref{fig:Map}.
The mean temperature in each region mostly depended on its latitude,
reflecting the climate of the region, while salinity in one site could
be considered as a proxy for evaporation and terrestrial inputs from
rivers.
