...
\significancestatement{Coexistence of multiple species of phytoplankton in a seemingly homogeneous environment, in spite of competition, is a long-standing puzzle of ecology. Based on a long-time monitoring study for 10 study sites every two weeks over 20 years, we explore the interaction networks that shape the diversity of phytoplanktonic ecosystems. We reveal that niche differentiation, rather than neutral processes, promote coexistence. Although phytoplanktonic systems are mainly seen as purely competitive, we show that a majority of interactions are facilitative, which can also stabilize the diversity of the community. This could pave the way to observation-based interaction matrices in theoretical studies of coexistence.}
