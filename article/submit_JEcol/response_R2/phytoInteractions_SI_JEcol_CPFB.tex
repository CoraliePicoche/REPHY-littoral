...
Thus, the order of magnitude between interaction strengths might change between MAR(1) and BH competition, depending on the species in presence and their relative contribution to the community. The mapping between Lotka-Volterra and MAR interaction strength ratios is therefore non-trivial in general.
