...
&=&\frac{1}{k(n-1)}&\left(\frac{1}{n}\sum_{i=1}^nb_{ii}\frac{N_T}{N_i} - \frac{1}{n}\sum_{i=1}^nb_{ii} \right)\\
&=&\frac{1}{k(n-1)}&\left(\frac{1}{n}\sum_{i=1}^nb_{ii}\frac{N_T}{N_i} - \overline{b_{ii}}\right)\\
\end{aligned}
...
\begin{equation}
\begin{aligned}
& \overline{b_{ij}}&=&\frac{1}{k(n-1)}\left(\frac{1}{n}\sum_{i=1}^nb_{ii}\frac{N_T}{N_i} - \overline{b_{ii}}\right)\\
\Leftrightarrow & \frac{\overline{b_{ij}}}{\overline{b_{ii}}}&=&\frac{1}{k(n-1)}\left(\frac{1}{n}\sum_{i=1}^n\frac{b_{ii}}{\overline{b_{ii}}}\frac{N_T}{N_i} - 1\right)\\
\Leftrightarrow & \frac{1}{\kappa}&=&\frac{1}{k(n-1)}\left(\frac{1}{n}\sum_{i=1}^n\frac{b_{ii}}{\overline{b_{ii}}}\frac{N_T}{N_i} - 1\right)
\end{aligned}
\end{equation}
