...
that still allowed interactions between groups. {\color{blue}However, in order to be as comprehensive as possible, we present results for the full/unconstrained matrix in a section below (``Comparison with a full interaction matrix'').}
