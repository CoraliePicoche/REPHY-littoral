...
both; {\color{blue}a detailed description of these different ways to compare intra- and inter-taxa interactions can be found in the Supporting Information.}
...
in which phylogenetic closeness decreases competition strength). {\color{blue} However, taxonomic resolution is unlikely to be the sole explanation for the high intra/inter ratio of interaction strength found here, for two reasons.} First, phytoplankton species belonging
...
or \citealt{murrell_heteromyopia_2003}). {\color{blue}Moreover, even with some microscale spatial segregation between
