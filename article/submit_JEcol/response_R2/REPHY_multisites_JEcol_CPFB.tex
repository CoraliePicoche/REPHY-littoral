...
properties \citep{ives_stability_1999}. {\color{blue} For a more thorough comparison of the maximum modulus of the eigenvalues in a discrete-time interaction matrix and the maximum real part of the eigenvalue in a continuous-time model, as well as more detail on the transition between the two types of model, see the Supporting Information.} Weighted connectance is a
...
exchanges. We also want to thank Bérangère Péquin for her constructive comments and Gyuri Barabás for {\color{blue} his precious advise on the connection between discrete- and continuous-time models as well as thoughtful remarks on the Random Matrix Theory}. This study was supported by the French
