...
communities. {\color{blue} We discuss below possible mechanistic interpretations}. 
...
though the spectral radius (largest modulus) {\color{blue}is here} tightly related to the real part of the lead eigenvalue 
{\color{blue} in equivalent continuous-time models (see Supporting Information)}. 
...
exchanges. We also want to thank Bérangère Péquin for her constructive comments and Gyuri Barabás for {\color{blue}thoughtful suggestions, especially regarding the connection to continuous-time stability theory}. This study was supported by the French ANR through LabEx COTE (ANR-10-LABX-45).

\subsubsection*{Supporting Information}
This article contains supporting information.

\subsubsection*{Authors' contributions}
CP and FB contributed equally to the project design. CP wrote the code for the analyses. FB and CP
