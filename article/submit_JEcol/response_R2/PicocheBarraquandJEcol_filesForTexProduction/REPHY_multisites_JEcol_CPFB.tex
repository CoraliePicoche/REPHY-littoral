...
exchanges. We also want to thank Bérangère Péquin for her constructive comments and Gyuri Barabás for thoughtful suggestions that improved the connection made to continuous-time stability theory. This study was supported by the French ANR through LabEx COTE (ANR-10-LABX-45).
...
\citep{REPHY_db} and all scripts for MAR models and subsequent network analyses
