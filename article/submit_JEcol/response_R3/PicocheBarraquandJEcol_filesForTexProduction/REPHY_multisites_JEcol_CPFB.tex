...
\subsubsection*{Data accessibility} The REPHY dataset has already been published \citep{REPHY_db}. All computer codes and datasets needed for analyses are available online in a GitHub repository (\url{https://github.com/CoraliePicoche/REPHY-littoral}) and archived at Zenodo (DOI:10.5281/zenodo.3743249). 
