...
the regulation a focal species exerted on itself. Vulnerability computed on raw coefficient values indicate
...
positive or negative?), while vulnerability computed on absolute coefficient values characterise the strength
