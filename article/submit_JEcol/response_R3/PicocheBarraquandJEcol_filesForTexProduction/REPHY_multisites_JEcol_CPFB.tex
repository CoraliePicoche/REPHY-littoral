...
\textbf{Correspondence}:\\ Frédéric Barraquand, CNRS, Institute of Mathematics of Bordeaux, 351 Cours de la Libération, 33405 Talence, France. * frederic.barraquand@u-bordeaux.fr
...
\subsubsection*{Data accessibility} The REPHY dataset has already been published \citep{REPHY_db}. All scripts for MAR models and subsequent network analyses
are available online in a GitHub repository (\url{https://github.com/CoraliePicoche/REPHY-littoral}) and Zenodo [address here XXXX]. 
