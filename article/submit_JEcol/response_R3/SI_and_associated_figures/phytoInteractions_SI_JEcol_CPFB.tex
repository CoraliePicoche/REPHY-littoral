...
\end{tabular}
\par\end{centering}
\caption{\textbf{Name and composition of the phytoplanktonic groups.} \fredadd{We generally refer to those groups as \emph{taxa}, though we sometimes use \emph{genera} to emphasize that they are above the species level (even though some are stricto sensu groups of genera)}. This taxonomic grouping is based on \citet{hernandez_farinas_assessing_2015}.\label{tab:Group_definition}}
\end{table}
