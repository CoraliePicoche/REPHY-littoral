...
\par\end{centering}
\caption{\textbf{Relation between mean and variance of the intra- and inter-taxa
...
\par\end{centering}
\caption{\textbf{Ratio of intra- to inter-taxa interaction strengths in MAR(1)
...
\begin{figure}[H]
    ...
    \caption{\textbf{Relationship between discrete-time stability metrics and their continuous-time equivalents} in (a); relationship between $\max(\text{Re}(\lambda_A))$ and an index of complexity, that is the variance of the off-diagonal coefficients weighted by the number of taxa in each community in (b).}
