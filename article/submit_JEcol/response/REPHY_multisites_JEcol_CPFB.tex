...
%\usepackage[utf8x]{inputenc} %%utf8x does not work with quotation marks ̀̀ ` '' 
...
between genera of phytoplankton} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
} \\

\bigskip{}

% \textbf{\large{}}\\
% {\large{}{Coexistence and facilitation in phytoplankton} %should be 45 characters or less. Here, we have 44
...
and also invariability, \citealt{arnoldi2019multidimensionality}) for the network
...
\nolinenumbers % \subsection*{Manuscript Length}
%\bibliographystyle{ecology_no_url}
 %\bibliographystyle{ecol_let_sortbyyear_v2}
