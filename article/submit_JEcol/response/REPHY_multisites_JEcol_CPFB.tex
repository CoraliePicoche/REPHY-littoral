...
The stability (\emph{sensu} resil	ience, \citealt{ives_stability_2007})
...
yielded ratios between 8 and 11 depending on the site (Table S3 and Figure S8 in the Supporting Information), % see code repository? 
...
the Supporting Information that the intra/inter ratio should remain commensurate in a MAR(1) model. 
...
model) are not strictly analogous to the ones used most frequently used in theoretical ecology (continuous-time model), 
though the spectral radius (largest modulus) is usually tightly related to the real part of the lead eigenvalue. 
