...
\usepackage{lineno} 
\usepackage{xr}
\externaldocument{phytoInteractions_SI}
...
\author{Coralie Picoche\textsuperscript{1,{*}} \& Frédéric Barraquand\textsuperscript{1,2}}
\maketitle

\lyxaddress{{\large{}}\textsuperscript{{\large{}1}}{\large{}~University of
Bordeaux, Integrative and Theoretical Ecology, LabEx COTE, Bât. B2
- Allée Geoffroy St-Hilaire, 33615 Pessac, France}}

\lyxaddress{{\large{}}\textsuperscript{{\large{}2}}{\large{}~CNRS, Institute
...
\begin{abstract}
{\normalsize{}The persistence of phytoplanktonic diversity in spite
...
{\let\thefootnote\relax\footnote{{* Correspondence: \texttt{coralie.picoche@u-bordeaux.fr} ; \texttt{frederic.barraquand@u-bordeaux.fr}}}}
...
producers that seemingly share the same basic resources \supercite{hutchinson_paradox_1961}.
Many theoretical studies of competition models have shown that competitive
exclusion is likely in those circumstances\supercite{armstrong1980competitive,chesson_updates_2018},
unless mechanisms involving spatial or temporal variation are at play\supercite{armstrong1976coexistence,chesson_roles_1997,huisman_biological_2001,li_effects_2016}.
Neutral theory, that assumes a non-equilibrium coexistence maintained
by dispersal and equal competitive abilities for all species\supercite{hubbell_unified_2001}
(though there are exceptions \supercite{volkov_neutral_2003,volkov_patterns_2007})
has been proposed as a solution to explain highly diverse communities\supercite{hubbell_unified_2001,rosindell2011unified}.
...
dwarfing interspecific competition in most cases\supercite{adler_coexistence_2010,adler_competition_2018}.
...
known (but see Mutshinda et al.\supercite{mutshinda_what_2009}).

Moreover, even within a single trophic level, competition may not
be the rule: the meta-analysis by Adler et al.\supercite{adler_competition_2018}
reported a large number of facilitative interactions (30\%) and several
reviews\supercite{brooker_facilitation_2008,mcintire2014facilitation}
...
models\supercite{coyte_ecology_2015}, multiple other modelling \supercite{gross_positive_2008}
and empirical\supercite{brooker_facilitation_2008,cavieres2009facilitative}
...
are considered simultaneously\supercite{mougi2012diversity,garcia2018effect}.
...
genera of phytoplankton \supercite{titman_ecological_1976,descamps-julien_stable_2005}.
...
between different classes or even phyla\supercite{ives_estimating_2003,hampton_sixty_2008,griffiths_phytoplankton_2015}.
...
\subparagraph*{Interaction estimates}

Using MAR(1) autoregressive models, we have produced interaction matrices\supercite{ives_estimating_2003,hampton2013quantifying}
-- i.e., Jacobian community matrices on the logarithmic scale\supercite{ives_estimating_2003}.
...
a more detailed analysis on one of the considered study regions\supercite{barraquand_coastal_2018}.
...
interactions\supercite{chamberlain_how_2014}. 

\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.9\textwidth]{graphe/biotic_interaction_matrices_MainFig_allin1_v4}
\par\end{centering}
...
a given region.\label{fig:Interaction-matrices}}
\end{figure}


\subparagraph*{Interaction network analysis}

The stability (\emph{sensu} resilience\supercite{ives_stability_2007})
...
\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.99\textwidth]{graphe/complexity_stability_MainFig_pencenjustB}
\par\end{centering}
...
joint community dynamics and interactions\supercite{james_constructing_2015}.
...
\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.99\textwidth]{graphe/pencen_generality_vs_vulnerability_MainFig}
\par\end{centering}
...
plots.\label{fig:Vulnerability_impact}}
\end{figure}
Aside from these trade-offs, some of which promote some stability
(\emph{sensu} invariability\supercite{Arnoldi431296}), we found no
...
\subparagraph*{Literature comparison}
...
taxa, the larger the intraspecific regulation\supercite{barabas_self-regulation_2017}.
...
\begin{figure}[H]
\begin{centering}
\includegraphics[width=0.8\textwidth]{graphe/Ratio_function_dim}
\par\end{centering}
...
95\% threshold). \label{fig:meta_ratio}}
\end{figure}


\section*{Discussion}

\paragraph*{Strong self-regulation and facilitation}
...
The rather high intra/intertaxon interaction strength ratio\supercite{levine_importance_2009}
...
of 4 to 5 by Adler et al. \supercite{adler_competition_2018}. Even
...
considered here are often found to compete in experiments\supercite{titman_ecological_1976,tilman_phytoplankton_1982,descamps-julien_stable_2005}.
There is therefore a massive difference between niches in the lab
and in the field\supercite{barraquand_coastal_2018}. Second, the
only other study that managed to provide MAR(1) estimates down to
the species level for phytoplankton, that of Huber and Gaedke\supercite{huber_role_2006},
...
meta-analysis by Adler et al.\supercite{adler_competition_2018} who
also found facilitative interactions, but a little less than here
($\approx$30\%). However, Adler et al.\supercite{adler_competition_2018}'s
review contains many experiments while the plant literature is replete
with field examples of facilitation \supercite{brooker_facilitation_2008,mcintire2014facilitation},
...
arising from hidden effects of resources or predator partitioning/sharing\supercite{chesson_updates_2018}.
In our previous publication investigating in detail the Arcachon study
sites\supercite{barraquand_coastal_2018}, we have argued that for
phytoplankton, the strong intragroup density-dependence could arise
from effects of natural enemies\supercite{haydon_pivotal_1994,barraquand_coastal_2018}.
Natural enemies could also very well create apparent mutualism between
prey species\supercite{abrams_apparent_1998,barraquand_indirect_2015,de_ruiter_emergent_2017}.
...
similar predators to the Arcachon site (zooplankton\supercite{jamet_zooplankton_2001,moderan_zooplankton_2010,tortajada_network_2012})
and parasites (viruses\supercite{ory_pelagic_2010}, fungi). Though
...
other known drivers of phytoplankton dynamics such as allelopathy\supercite{felpeto_allelopathy_2018},
auxotrophy\supercite{tang_most_2010} or hydrodynamics\supercite{levy_role_2018}
...
Burson et al.\supercite{burson_competition_2018} constitute an example
...
\paragraph*{No complexity-stability relationship but connections between self-regulation
...
stability is distorted in that case\supercite{certain_how_2018}),
...
description of the system\supercite{barraquand_coastal_2018}. Therefore,
...
by Jacquet et al.\supercite{jacquet_no_2016} using a different technique,
even though it does contradict previous results on random matrices,
especially for competitive and/or mutualistic networks\supercite{allesina_stability_2012}.
We also found that the percentage of mutualistic interactions, that
is thought to affect the stability of the network\supercite{mougi2012diversity,coyte_ecology_2015,garcia-callejas_multiple_2018},
...
abundance, which echoes findings by Yenni et al.\supercite{yenni_persistent_2017}
...
\subparagraph*{Ghosts of competition past and present}
...
found in plant community studies\supercite{volkov_patterns_2007,adler_competition_2018}
or empirical food webs including horizontal diversity\supercite{barabas_self-regulation_2017}.
...
might be likewise destabilizing\supercite{coyte_ecology_2015}). The
...
predators can make strong conspecific density-dependence emerge\supercite{bagchi_pathogens_2014,comita_testing_2014},
while switching generalists can also promote diversity\supercite{vallina2014maximal}.
Both predators and resources have often symmetrical effects and can
therefore contribute almost equally to such past niche differentiation\supercite{chesson_updates_2018}.
\begin{flushleft}
An intriguing new possibility, dubbed the ``ghost of competition
present''\supercite{tuck_strong_2018}, suggests by contrast that
...
the effect of competitors that are uncovered by removal experiments\supercite{tuck_strong_2018,adler_weak_2018}.
...
where it is relatively competitive (Pacala's spatial segregation hypothesis\supercite{pacala1997biologically}),
...
at the microscale\supercite{barton_impact_2014,breier_emergence_2018}
but it is quite unclear how this affects multivariate spatial patterns
of species distributions (\textit{sensu} Bolker and Pacala\supercite{bolker_spatial_1999}
or Murrell and Law\supercite{murrell_heteromyopia_2003}). Moreover,
...
(REPHY\supercite{REPHY_db}). Since 1987, this monitoring program
...
microscope\supercite{utermohl_zur_1958}. Throughout the years and
...
level based on previous work\supercite{hernandez_farinas_assessing_2015,barraquand_coastal_2018},
...
\supercite{hampton_coalescence_2006}. We tested extensively this
and other methods to deal with missing data in a previous publication
on a subset of this dataset \supercite{barraquand_coastal_2018}.
...
dynamics\supercite{ives_estimating_2003}. MAR(1) models are based
...
the results\supercite{barraquand_coastal_2018}.

We used the MARSS package\supercite{holmes_analysis_2014} v3.9, in
R v3.3.2\supercite{venables_r_2013}, to estimate parameters with
a maximum likelihood procedure.

We have previously published a detailed analysis of one of the dataset
(Arcachon) for which more covariables were available\supercite{barraquand_coastal_2018},
...
abiotic influences\supercite{scheef_inferring_2013}. The analysis
of real data in Barraquand et al.\supercite{barraquand_coastal_2018}
...
was observed\supercite{adler_coexistence_2010,ellner_how_2016}).
Furthermore, using two abiotic variables (temperature and salinity)
in this study rather than the full set used in Barraquand et al.\supercite{barraquand_coastal_2018}
led to almost identical estimates to the ones obtained previously\supercite{barraquand_coastal_2018}.
...
estimates) and sign of interaction coefficients\supercite{certain_how_2018},
...
of both real data and similar simulated datasets\supercite{barraquand_coastal_2018}.
...
determine the stability of a discrete-time dynamical system\supercite{ives_estimating_2003}.
...
and linkage density\supercite{breier_emergence_2018}. Weighted connectance
...
matrices by BIC\supercite{ives_estimating_2003}. The latter choice
...
of the REPHY program\supercite{REPHY_db} by Ifremer, providing invaluable
...
CP and FB contributed equally to the project design. CP wrote the
code for the analyses. FB and CP interpreted the results and wrote
the manuscript.
