parmat_tmp = function( MLEobj, elem=c("B","U","Q","Z","A","R","x0","V0","G","H","L"), t=1, dims=NULL, model.loc="marss" ){
  ...
  elem=c("B","U","Q","Z","A","R","x0","V0")
  model=MLEobj[[model.loc]]
  pars=MLEobj[["par"]]
  f=model[["fixed"]]
  d=model[["free"]]
####This is the worst code I could possibly do
#  f[['G']]=f[['Q']]
#  f[['H']]=f[['R']]
#  f[['L']]=f[['V0']]
#  d[['G']]=d[['Q']]
...
#	print(dim(pars[[el]]))
	...
	par.mat[['G']]=diag(dim(par.mat$Q)[1])
	par.mat[['H']]=diag(dim(par.mat$R)[1])
	par.mat[['L']]=diag(dim(par.mat$V0)[1])
  }
  return(par.mat)
}

MARSSkfss_tmp = function( MLEobj ) {
