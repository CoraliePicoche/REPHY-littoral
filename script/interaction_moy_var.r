...
for (g in groupe){
        ...
        for (ll in 1:length(option_lieu)){
			...
			metrics=networklevel(web=abs(B),index=c("linkage density","weighted connectance"))
...
pdf(paste("Rapport/graphe/MAR_estimates/moy_var_per_subsite_",option_model,"_",extant,".pdf",sep=""))
...
pdf(paste("Rapport/graphe/MAR_estimates/moy_var_ratio_per_subsite_",option_model,"_",extant,".pdf",sep=""),width=14)
...
pdf(paste("Rapport/graphe/MAR_estimates/moy_vs_var_",option_model,"_",extant,".pdf",sep=""),width=12)
par(mfrow=c(1,3),mar=c(4,4,3,0.025))
xlimi=c(min(tab_value[,"intra_mean"]),max(tab_value[,"intra_mean"]))
ylimi=c(min(tab_value[,"intra_var"]),max(tab_value[,"intra_var"]))
plot(0,0,t="n",xlab="Mean",ylab="Variance",xlim=xlimi,ylim=ylimi,main="Intra")
for(i in 1:dim(tab_value)[1]){
	points(tab_value[i,"intra_mean"],tab_value[i,"intra_var"],pch=16,col=colo[i])
        text(tab_value[i,"intra_mean"],tab_value[i,"intra_var"],rownames(tab_value)[i],col=colo[i],adj=0,xpd=NA)
}
legend("topright",paste(format(mean(tab_value[,"intra_mean"]),digits=2),"(",format(tab_value[i,"intra_var"],digits=2),")",sep=""),bty="n")
...
plot(0,0,t="n",xlab="Mean",ylab="",xlim=xlimi,ylim=ylimi,main="Inter raw")
for(i in 1:dim(tab_value)[1]){
        points(tab_value[i,"inter_mean_raw"],tab_value[i,"inter_var_raw"],pch=16,col=colo[i])
        text(tab_value[i,"inter_mean_raw"],tab_value[i,"inter_var_raw"],rownames(tab_value)[i],col=colo[i],adj=0,xpd=NA)
}
legend("topleft",paste(format(mean(tab_value[,"inter_mean_raw"]),digits=2),"(",format(tab_value[i,"inter_var_raw"],digits=2),")",sep=""),bty="n")
...
plot(0,0,t="n",xlab="Mean",ylab="",xlim=xlimi,ylim=ylimi,main="Inter abs")
for(i in 1:dim(tab_value)[1]){
        points(tab_value[i,"inter_mean_abs"],tab_value[i,"inter_var_abs"],pch=16,col=colo[i])
        text(tab_value[i,"inter_mean_abs"],tab_value[i,"inter_var_abs"],rownames(tab_value)[i],col=colo[i],adj=0,xpd=NA)
}
legend("topleft",paste(format(mean(tab_value[,"inter_mean_abs"]),digits=2),"(",format(tab_value[i,"inter_var_abs"],digits=2),")",sep=""),bty="n")
dev.off()

pdf(paste("Rapport/graphe/MAR_estimates/stability_vs_var_",option_model,"_",extant,".pdf",sep=""),width=12)
par(mfrow=c(1,3),mar=c(4,4,3,0.025))
ylimi=c(min(tab_value[,"stability"]),max(tab_value[,"stability"]))
xlimi=c(min(tab_value[,"intra_var"]),max(tab_value[,"intra_var"]))
plot(0,0,t="n",xlab="Var",ylab="Stability",xlim=xlimi,ylim=ylimi,main="Intra")
for(i in 1:dim(tab_value)[1]){
        points(tab_value[i,"intra_var"],tab_value[i,"stability"],pch=16,col=colo[i])
        text(tab_value[i,"intra_var"],tab_value[i,"stability"],rownames(tab_value)[i],col=colo[i],adj=0,xpd=NA)
}
xlimi=c(min(tab_value[,"inter_var_raw"]),max(tab_value[,"inter_var_raw"]))
plot(0,0,t="n",xlab="Var",ylab="",xlim=xlimi,ylim=ylimi,main="Inter raw")
for(i in 1:dim(tab_value)[1]){
        points(tab_value[i,"inter_var_raw"],tab_value[i,"stability"],pch=16,col=colo[i])
        text(tab_value[i,"inter_var_raw"],tab_value[i,"stability"],rownames(tab_value)[i],col=colo[i],adj=0,xpd=NA)
}
xlimi=c(min(tab_value[,"inter_var_abs"]),max(tab_value[,"inter_var_abs"]))
plot(0,0,t="n",xlab="Mean",ylab="",xlim=xlimi,ylim=ylimi,main="Inter abs")
for(i in 1:dim(tab_value)[1]){
        points(tab_value[i,"inter_var_abs"],tab_value[i,"stability"],pch=16,col=colo[i])
        text(tab_value[i,"inter_var_abs"],tab_value[i,"stability"],rownames(tab_value)[i],col=colo[i],adj=0,xpd=NA)
}
dev.off()

pdf(paste("Rapport/graphe/MAR_estimates/metrics_vs_stability_",option_model,"_",extant,".pdf",sep=""),width=12)
...
pdf(paste("Rapport/graphe/MAR_estimates/moy_vs_var_for_all_interactions_",option_model,"_",extant,".pdf",sep=""),width=12)
par(mfrow=c(1,2))
...
plot(x1,y1,col=colo,pch=16,xlab="Mean",ylab="Variance")
text(mean(tab_value[,'inter_mean_raw']),min(tab_value[,"intra_var"]),"Inter raw",xpd=NA)
plot(x2,y2,col=colo,pch=16,xlab="Mean",ylab="")
text(mean(tab_value[,'inter_mean_abs']),min(tab_value[,"intra_var"]),"Inter abs",xpd=NA)
dev.off()
