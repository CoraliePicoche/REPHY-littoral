...
legend("topright",paste(format(mean(tab_value[,"intra_mean"]),digits=2),"(",format(tab_value[i,"intra_var"],digits=2),")",sep=""),bty="n",cex=2.5)
...
legend("topleft",paste(format(mean(tab_value[,"inter_mean_raw"]),digits=2),"(",format(tab_value[i,"inter_var_raw"],digits=2),")",sep=""),bty="n",cex=2.5)
...
legend("topleft",paste(format(mean(tab_value[,"inter_mean_abs"]),digits=2),"(",format(tab_value[i,"inter_var_abs"],digits=2),")",sep=""),bty="n",cex=2.5)
dev.off()
